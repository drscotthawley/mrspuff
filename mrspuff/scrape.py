...
# %% auto 0
__all__ = ['ddg_images', 'search_images_ddg', 'download_and_save', 'search_and_download', 'img_scrape', 'browse_images',
...
def search_images_ddg(key, max_n=200, debug=False):
    ...
    for p in tqdm(range(n_pages)):
        ...
        results = DDGS().images(
            query=key,
            #region="us-en", #don't care
            safesearch="on", # do care
            timelimit="m",
            page=p,
            backend="auto",
            size=None,
            #color="Monochrome", # don't care
            type_image=None,
            layout=None,
            license_image=None,
        )
