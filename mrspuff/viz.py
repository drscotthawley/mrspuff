...
# %% auto 0
__all__ = ['plotly_already_setup', 'CDH_SAMPLE_URLS', 'bokeh_already_setup', 'TrianglePlot2D_MPL', 'sorted_eig', 'pca_proj',
           'setup_plotly', 'TrianglePlot3D_Plotly', 'setup_bokeh', 'TrianglePlot2D_Bokeh', 'VizPreds', 'image_and_bars']
